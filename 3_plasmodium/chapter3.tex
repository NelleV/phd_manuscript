...
\chapter{Genome architecture of the \emph{P. falciparum} genome} % top level followed by section, subsection
...
parasite (Fig.~\ref{fig:fig1}a, Supplementary Note 1, Supplementary File 1).
...
(Fig.~\ref{fig:fig1}b, Supplementary Fig.~\ref*{suppfig:power-law}). Second,
...
(Supplementary Table~\ref*{table:ICP}). Third, we observed that the percentage
...
in yeast \citep{duan:three} (Supplementary Table~\ref*{table:ICP}). Together,
...
\citep{imakaev:iterative} (Fig.~\ref{fig:fig1}c, Supplementary
...
Supplementary Note 2, Supplementary File 2)~\citep{ay:statistical}. We
...
enrichment of VRSM genes for the ring and trophozoite stages (Supplementary
...
\citep{umbarger:three-dimensional} (Fig.~\ref{fig:fig1}c-d, Supplementary
...
evasion (Supplementary File 3; VRSM genes: {\em var}, {\em rifin}, {\em
stevor} and {\em Pfmc-2tm})---chromosomes 4, 6, 7, 8 and 12---exhibit
additional folding structure (Fig.~\ref{fig:fig1}c-d, Supplementary
...
expected distances (Supplementary Table~\ref*{table:stabilityToBeta}). This
...
(Supplementary Table~\ref*{table:stabilityToConstraints}). Finally, our
...
(Supplementary Fig.~\ref*{suppfig:compareStructurePairs}), do not fall into
discrete clusters (Supplementary Fig.~\ref*{suppfig:CHindices}) and all such
structures exhibit common organizational hallmarks (Supplementary
...
across all three stages (Fig.~\ref{fig:fig2}a, Supplementary
Fig.~\ref*{suppfig:3Dcentromeres}, Supplementary Table~\ref*{table:witten}),
...
matrix of pairwise distances between compartments (Supplementary
...
centromeres for this stage (Supplementary Fig.~\ref*{suppfig:compDists}d).
...
one another (Fig.~\ref{fig:fig2}a, Supplementary Table~\ref*{table:witten}).
...
distances to perform colocalization tests similar to Supplementary
...
fluorescence {\em in situ} hybridization (FISH) (Methods, Supplementary Note
...
of cells, Fig.~\ref{fig:fig2}b, Supplementary Fig.~\ref*{suppfig:fish}a,
Supplementary Table~\ref*{table:FISHprimers}), providing independent support
...
($>$90\% of cells, Fig.~\ref{fig:fig2}c, Supplementary
...
loci ($<$10\% of cells, Supplementary Fig.~\ref*{suppfig:fish}c). These
...
4.47x and 4.61x, respectively, Supplementary
Fig.~\ref*{suppfig:rDNAunitsOn3D}a-c). Control libraries from both studies do
not exhibit this enrichment (Fig.~\ref{fig:fig3}d, Supplementary
...
erythrocytic cycle (Supplementary Table~\ref*{table:witten}).  This
...
parasite progresses through its cell cycle (Supplementary Files 4-18). We then
characterized global chromatin changes by analyzing the relationship between
contact frequency and genomic distance (Fig.~\ref{fig:fig1}b, Supplementary
...
(Supplementary Table~\ref*{table:scalingFactors}).
...
interchromosomal contact probabilities for each stage (Supplementary
...
territory preservation for the schizont stage (Supplementary
...
in the transition from the ring to trophozoite stage (Supplementary
...
the schizont stage (Supplementary Fig.~\ref*{suppfig:compMovement}b, blue
...
matrices (Fig.~\ref{fig:fig5}a-b, Supplementary
...
(Supplementary Fig.~\ref*{suppfig:TADs}), suggesting that VRSM gene clusters
...
Supplementary Fig.~\ref*{suppfig:perChrFigs}). This striking overlap  suggests
...
by excluding all VRSM genes (Supplementary
...
(Supplementary Fig.~\ref*{suppfig:expVSdistWithoutVRSM}). It is also important
...
(Supplementary Fig.~\ref*{suppfig:distToCenter}a,b). Similar analysis showed
higher expression levels for genes located near the nuclear center, as well as
for genes close to the centroid of the centromeres (Supplementary
...
clusters identified in \cite{leroch:discovery} (Supplementary
...
the opposite side of the nucleus  (Fig.~\ref{fig:fig6}c, Supplementary
Fig.~\ref*{suppfig:kCCAsecond}a,c,e). The coherence with 3D structure drops
significantly in the second component of the kCCA (Supplementary
...
respectively, of the extracted kCCA expression profile (Supplementary
...
consistent enrichment in the strongest kCCA profile (Supplementary
...
by the 3D genome structure (Supplementary
...
(Supplementary Fig.~\ref*{suppfig:intraVSinter}b-e). The difference between
...
high variance (Supplementary Fig.~\ref*{suppfig:intraVSinter}a versus b). Even
