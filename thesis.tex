...
\newcommand{\jp}[1]{\textcolor{red}{{\bf [JP: #1]}}} % Add Specific comment (JP)
\newcommand{\mm}[1]{\textcolor{red}{{\bf [MM: #1]}}} % Add Specific comment (Matahi)
\newcommand{\fr}[1]{\textcolor{red}{{\bf [FR: #1]}}} % Add Specific comment (Fabien)
...
%\include{8_centurion_supplementaries/supp}
