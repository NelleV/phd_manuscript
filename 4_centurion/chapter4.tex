...
Les centromères sont des élèments génomiques permettant la segrégation
...
plupart des espèces. Récemment, le protocol de capture de conformation des
chromosome Hi-C, initiallement développé pour étudier la structure 3D du
...
une méthode, nommée Centurion, qui permet l'inférence jointe de la position de
tous les centromères à la fois d'un organisme à partir de données Hi-C en exploitant la
propriété qu'ont les centromères de certains organismes à colocalizer dans le noyau.
