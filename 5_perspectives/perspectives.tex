...
in particular \textit{3D structure inference} methods.

\textbf{Biological contributions}\ - During the course of my thesis, I
studied, in collaboration with Le Roch lab and Noble lab, the
three-dimensional structure of the human malaria parasite \textit{P.
falciparum}, which led to a better understanding of links between the genome
architecture and gene expression and regulation.
